...
from netraven.worker.jobs.base import BaseJob, ParamsModel
import subprocess
import socket
...
class ReachabilityJob(BaseJob):
    name = "reachability"
    description = "Performs ICMP and TCP reachability checks on the device."
    Params = Params
    # Optionally, you can add icon, label, default_schedule as class attributes if needed
