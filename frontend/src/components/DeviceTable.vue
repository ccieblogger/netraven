  ...
  <div>
    ...
    <div class="overflow-x-auto px-2">
      ...
      >
        ...
        <Column field="hostname" header="Hostname" sortable class="px-4" :headerClass="'bg-slate-800 text-text-primary font-semibold'" :bodyClass="bodyClass('hostname')" />
        <Column field="ip_address" header="Host IP" sortable class="px-4" :headerClass="'bg-slate-800 text-text-primary font-semibold'" :bodyClass="bodyClass('ip_address')" />
        <Column field="serial" header="Serial" class="px-4" :headerClass="'bg-slate-800 text-text-primary font-semibold'" :bodyClass="bodyClass('serial')" />
        <Column header="Reachable" class="px-4" :headerClass="'bg-slate-800 text-text-primary font-semibold'">
          <template #body="{ data }">
            <ServiceDot
        ...
        <Column field="job_status" header="JobStat" class="px-4" :headerClass="'bg-slate-800 text-text-primary font-semibold'" :bodyClass="bodyClass('job_status')" />
        <Column header="Tags" class="px-4" :headerClass="'bg-slate-800 text-text-primary font-semibold'">
          <template #body="{ data }">
        ...
        <Column header="Credential" class="px-4" :headerClass="'bg-slate-800 text-text-primary font-semibold'">
          <template #body="{ data }">
        ...
        <Column header="Actions" class="px-4" :headerClass="'bg-slate-800 text-text-primary font-semibold'">
          <template #body="{ data }">
        ...
        <Column header="Other" class="px-4" :headerClass="'bg-slate-800 text-text-primary font-semibold'">
          <template #body="{ data }">
            <div class="flex flex-row space-x-1">
...
// Add rowClass for alternating row backgrounds
function rowClass(data, options) {
  if (!options || typeof options !== 'object' || typeof options.rowIndex !== 'number') {
    return '';
  }
  return options.rowIndex % 2 === 0 ? 'bg-slate-900' : 'bg-slate-800';
}
